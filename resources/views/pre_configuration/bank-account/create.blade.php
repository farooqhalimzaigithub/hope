		...
		<div class="row">
			<div class="col-lg-12">
				...
				<!-- <div class="card card-custom gutter-b example example-compact" style="border : 1px solid yellow;"> -->
					...
					<form class="form  mt-12"  method="post" action="{{route('bank_accounts.store')}}" >
						@csrf
						...
						<div class="row">
							<div class="col-lg-4">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control form-control-solid form-control-lg" name="account_name"  required="" />
							...
							<div class="col-lg-4">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control form-control-solid form-control-lg" name="account_no"  required="" />
						...
						<div class="row">
							...
							<div class="col-lg-4">
								...
								<div class="form-group">
									...
									<input type="number" class="form-control form-control-solid form-control-lg branch_code" readonly="" id="branch_code" name="branch_code"  required="" />
							...
							<div class="col-lg-4">
								...
								<div class="form-group">
									...
									<input type="number" class="form-control form-control-solid form-control-lg" name="opening_balance"  required="" placeholder="0.0" />
