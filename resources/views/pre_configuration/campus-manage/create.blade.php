								...
								<div class="row">
									<div class="col-lg-12">
										...
										<!-- <div class="card card-custom gutter-b example example-compact" style="border : 1px solid yellow;"> -->
											...
											<form class="form  mt-12"  method="post" action="{{route('campuses.store')}}" >
			@csrf
				...
				<div class="row">
					...
					<div class="col-xl-6">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control form-control-solid form-control-lg" name="location"  required="" />
