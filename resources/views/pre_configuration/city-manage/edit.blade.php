								...
								<div class="row mt-0 mt-lg-1" >
									<div class="col-xl-12">
										...
										<div class="card card-custom gutter-b card-stretch "  >
											...
											<form class="form  mt-12"  method="post" action="{{route('cities.update',$city->id)}}" >
			@csrf
			@method('PUT')
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="form-group">
							<label>Name</label>
							<input type="text" class="form-control form-control-solid form-control-lg" name="name" value="{{$city->name}}"  required="" />
