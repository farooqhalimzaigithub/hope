...
<div class="d-flex flex-column-fluid">
							...
							<form class="form  mt-12"  method="post" action="{{route('examtypes.store')}}" >
                           @csrf
...
<div class="row">
	<div class="col-xl-12">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control form-control-solid form-control-lg" name="exam_type"  required="" />
