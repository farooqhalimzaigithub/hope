								...
								<div class="row">
									<div class="col-lg-12">
										...
										<!-- <div class="card card-custom gutter-b example example-compact" style="border : 1px solid yellow;"> -->
											...
											<form class="form  mt-12"  method="post" action="{{route('branches.store')}}" >
			@csrf
				...
				<div class="row">
					<div class="col-lg-6">
						...
						<div class="form-group">
							<label>Name</label>
							<input type="text" class="form-control form-control-solid form-control-lg" name="branch_code"  required="" />
