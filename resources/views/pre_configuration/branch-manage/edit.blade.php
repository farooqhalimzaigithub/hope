								...
								<div class="row">
									<div class="col-lg-12">
										...
										<!-- <div class="card card-custom gutter-b example example-compact" style="border : 1px solid yellow;"> -->
											...
											<form class="form  mt-12"  method="post" action="{{route('branches.update',$branch->id)}}" >
			@csrf
			@method('PUT')
				...
				<div class="row">
					<div class="col-xl-6">
						...
						<div class="form-group">
							<label>Code</label>
							<input type="text" class="form-control form-control-solid form-control-lg" name="branch_code" value="{{$branch->branch_code}}"  required="" />
					...
					<div class="col-xl-6">
						...
						<div class="form-group">
							<label>Name</label>
							<input type="text" class="form-control form-control-solid form-control-lg" name="branch_name" value="{{$branch->branch_name}}"  required="" />
							<span class="form-text text-muted">Please enter Name</span>
						</div>
						<!--end::Input-->
					</div>
