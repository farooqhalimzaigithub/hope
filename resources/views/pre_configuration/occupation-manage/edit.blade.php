									...
									<div class="col-lg-12">
										...
										<!-- <div class="card card-custom gutter-b example example-compact" style="border : 1px solid yellow;"> -->
											<div class="card-header">
												<h3 class="card-title">Occupation  Form</h3>
											...
											<form class="form  mt-12"  method="post" action="{{route('occupations.update',$occupation->id)}}" >
			@csrf
			@method('PUT')
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="form-group">
							<label>Name</label>
							<input type="text" class="form-control form-control-solid form-control-lg" name="name" value="{{$occupation->name}}"  required="" />
