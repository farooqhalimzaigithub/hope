								...
								<div class="row">
									<div class="col-lg-12 bg-white">
										...
										<!-- <div class="card card-custom gutter-b example example-compact" style="border : 1px solid yellow;"> -->
											...
											<form class="form  mt-4"  method="post" action="{{route('staff_categories.update',$staff->id)}}" >
			@csrf
			@method('PUT')
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control form-control-solid form-control-lg" value="{{$staff->name}}" name="name"  required="" />
