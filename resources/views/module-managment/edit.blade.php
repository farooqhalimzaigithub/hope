								...
								<div class="row mt-0 mt-lg-1" >
									<div class="col-xl-12">
										...
										<div class="card card-custom gutter-b card-stretch "  >
											<h4 class="mb-8 mt-6 font-weight-bold text-dark">Update Module Details</h4>
											<form class="form  mt-12"  method="post" action="{{route('modules.update',$module->id)}}" >
			@csrf
			@method('PUT')
				...
				<div class="row">
					<div class="col-xl-3">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control form-control-solid form-control-lg" name="name" placeholder="Name" value="{{$module->name}}" />
					...
					<div class="col-xl-3">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control form-control-solid form-control-lg" name="route_name" value="{{$module->route_name}}" placeholder="Route Name" />
					...
					<div class="col-xl-3">
						...
						<div class="form-group">
							<label>Url</label>
							<input type="text" class="form-control form-control-solid form-control-lg" name="route_url" value="{{$module->route_url}}" placeholder="Url" />
					...
					<div class="col-xl-3">
						<div class="form-group">
							...
							<select name="parent_id" class="form-control form-control-solid form-control-lg">
								<option value="1">  It Self</option>
								@foreach($modules as $value)
								@if($value->parent_id==$module->parent_id)
